...
import one.beefsupreme.shibachatandroid.ui.destinations.FriendsScreenDestination
...
enum class BottomBarDestination(
  ...
  Friends(FriendsScreenDestination, Icons.Default.Email, R.string.friends_screen),
